...
<div x-cloak x-show="selected_project=={{$show_number}}" x-transition.duration.500ms x-transition.delay.500ms>
    <div class="grid grid-cols-7">
        <figure class="md:col-span-2 col-span-7 flex justify-center items-center p-5 p-r-10 bg-lime-cream-50">
            ...
            <div class="relative hover:[&_div]:opacity-100 hover:[&_div]:transition hover:[&_div]:duration-200ms"><a href="{{$link}}" target="_blank"><img class="border-2 border-black rounded-lg"
                                                          src="/storage/projects/{{$image}}"
                                                          alt="detail project view image">


                <div class="absolute inset-0 opacity-0 rounded-lg text-xl bg-black/50 flex justify-center items-center text-white">
                    View
                </div>
                </a>
            </div>
        ...
        <div class="md:col-span-5 col-span-7 flex flex-col gap-4 [&_p]:p-3 md:border-t-none md:border-l border-t border-black">
            ...
            <div
                ...
                <p><span class="font-bold">{{$individual? "What does it contain?:":"What I contributed?:"}} </span>{{$contributed}}</p>
