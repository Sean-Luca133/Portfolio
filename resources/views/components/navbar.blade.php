...
<nav class=" z-10 h-[15vh] bg-granite-600 relative  sticky top-0 border-b-2 border-black dark:border-white mb-5">

        <h1 class="text-3xl py-5 text-center">test</h1>
        ...
        <ul class=" flex justify-center absolute -bottom-5 left-2 [&_li]:text-sm [&_li]:md:text-base [&_li]:p-2 [&_li]:font-bold [&_li]:font-header [&_li]:bg-dusty-olive-300 [&_li]:border-y-2 [&_li]:border-black dark:[&_li]:border-white ">
            ...
            <li class="{{$current == 'about_me'? '!bg-orange-300':''}}"><a href="{{route('about_me')}}">about_me</a></li>
