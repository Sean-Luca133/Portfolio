...
<div class="border-2 border-black rounded-lg flex flex-col no-underline hover:-translate-y-1 hover:shadow-[5px_5px_0_#111] transition-all duration-200">
    ...
    <a href="{{ route($route) }}">
        <div class="{{ $footer_color }} border-t-2 border-black px-5 py-2 flex justify-between items-center rounded-b-lg">
            <span class="text-[10px] font-bold font-main tracking-widest">{{ $label }}</span>
            <span class="font-bold text-base hover:text-light-green-700 transition duration-200">→</span>
        </div>
    </a></div>
