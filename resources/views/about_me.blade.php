<x-layouts.portfolio title="Who am I?">
    <p class="my-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ipsa iste obcaecati perferendis qui! Dolorum
        excepturi
        ...
        nobis odit praesentium quam rem rerum suscipit ullam veniam voluptatum.</p>

    <h2 class="font-header text-2xl">Brief introduction</h2>
    <x-content_box><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam at cupiditate facilis hic illum
            ...
            exercitationem
            fuga fugit, itaque magnam modi nisi, possimus quam quas quo recusandae reiciendis repudiandae sit tenetur
            voluptates? A animi architecto aspernatur delectus deserunt dolore earum error eum excepturi exercitationem
            expedita illum in incidunt maiores nostrum nulla, optio perspiciatis quam qui sit tempora unde voluptate? Ab
            eius laborum nemo quod repudiandae voluptates!</p>
    </x-content_box>

    <h2 class="font-header text-2xl">Why applied computer science?</h2>
    <x-content_box reverse><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam at cupiditate facilis hic illum
            laudantium, nesciunt quod veniam voluptas voluptate. Accusamus consequatur exercitationem incidunt iusto
            laborum
            molestias nostrum officiis perferendis? Atque consectetur eligendi hic nemo perspiciatis quo reiciendis,
            reprehenderit! Accusamus aliquam aliquid architecto at consequatur cum delectus distinctio enim
